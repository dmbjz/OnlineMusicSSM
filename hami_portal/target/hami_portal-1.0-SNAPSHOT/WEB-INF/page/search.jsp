    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            * */
            ...
            $("a[ftype='isNew'][value='" + isNew + "']").addClass("current");//新歌回显
        ...
        function loadMore() {
            ...
            window.location.href = "/song/list?tid=" + tid + "&isHot=" + isHot + "&isNew=" + isNew + "&pageSize=" + pageSize + "&pageNoPortal=" + pageNoPortal;
        }

        function selectAll(checkobj) {
            var checked = $(checkobj).attr("checked");//获取到当前的值
            if (checked == "checked") {
                ...
                <table>
                    <tr>
                        ...
                        <td class="subnav">
                            ...
                            <a class="bigtext middle  " href="/songer/list">音乐人</a>
                        </td>
                        <td class="search">
                            <div class="container">
                                <div class="form">
...
<div id="body" class="gap">
    ...
    <input type="hidden" value="${mq.isNew}" id="isNew">
    <div class="wrapper">
                        ...
                        <c:forEach items="${page.list}" varStatus="status" var="song">
                            <tr data-index="0">
                                ...
                                <td>
                                    <div class="song">
                                        <div class="image">
                                            <img src="${filePath}${song.pic}" alt="Every Breath You Take" height="55"
                                                 width="55"/>
                                            <b></b>
                                        </div>
                                ...
                                <td><span>
                                            <a target="_blank" href="https://i.xiami.com/karensouza"
                                               title="Karen Souza">${song.songer.srname}</a>
                                    	</span></td>
                                <td><span>
                <a target="_blank" title="Essentials"
                   href="https://emumo.xiami.com/album/432660">${song.album.aname}</a>
            </span></td>
                                <td>
                                    <div class="action">
                                        <button class="play" title="试听" onclick="play(${song.sid})">试听</button>
