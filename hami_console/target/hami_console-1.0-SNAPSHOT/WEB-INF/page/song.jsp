    ...
    <script>
        ...
        $(function () {
            ...
            $("[modify]").click(function () {
                ...
                window.location.href = "/song/updatelist?sid="+sid;
            });
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls form-group">
                                        <div class="input-group"> <span class="input-group-addon"><i class="icon-music"></i></span>
                                            <input type="text" name="sname" value="${mq.sname}" id="sname" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls form-group">
                                        <div class="input-group"> <span class="input-group-addon"><i class="icon-reorder"></i></span>
                                            <input type="text"  name="aname" value="${mq.aname}" id="aname" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table table-striped table-images" style="color: white;font-size: 14px">
                                    ...
                                    <c:forEach items="${page.list}" var="song">
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="${filePath}${song.pic}"/></td>
                                            <td> ${song.sname} </td>
                                            ...
                                            <td><button class="btn btn-sm btn-primary" modify id="changeSub" type="button" sid="${song.sid}"> 修改 </button>
                                                <button data-toggle="button" class="btn btn-sm btn-warning" sid="${song.sid}"> 删除 </button></td>
                                        </tr>
                                    </c:forEach>
