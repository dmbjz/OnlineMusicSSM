                        ...
                        <div class="widget-content">
                            <div class="body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <label for="" class="control-label">封面<span class="required">*</span></label>
                                        <div class="controls form-group">
                                                ...
                                                <div class="image-row">
                                                    <div class="image-set">
                                                        <a class="example-image-link" href="../../img/gallery-photo/image-3.jpg" data-lightbox="example-set" title="Click on the right side of the image to move forward.">
                                                            <img id="songImg" class="example-image" src="../../img/gallery-photo/image-3.jpg" alt="Plants: image 1 0f 4 thumb" width="150" height="150" />
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="examples" class="section examples-section">
                                            ...
                                            <input type="file" name="picfile" id='i-file'  accept=".jpg, .png" onchange="submitPic()" style="display: none">
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            ...
                                            <span class="help-block">请添加lrc格式歌词</span> </div>
                                    </div>
                                    <div class="control-group">
