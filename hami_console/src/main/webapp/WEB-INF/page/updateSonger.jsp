...
<head>
    ...
    <script>
        ...
        function subSongerUpdate() {
            window.location.href="/songer/update";
        }
...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-title">修改艺人<small> 明星闪耀</small></h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="widget">
                        ...
                        <input type="hidden" name="srid" value="${songer.srid}" id="srid">
                        <div class="widget-content">
                            ...
                            <div class="body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <input type="text" class="col-sm-6 col-xs-12 parsley-validated" required="" value="${songer.srname}" name="srname" id="srname" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label for="area" class="control-label">地区</label>
                                        <div class="controls form-group">
                                            <input type="text" class="col-sm-6 col-xs-12" name="area" value="${songer.area}" id="area" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                            ...
                                            <div data-toggle="buttons" class="btn-group col-sm-2 " >
                                                <select id="tid" name="tid" class="form-control ">
                                                    <c:forEach items="${mtypes}" var="mtype">
                                                        <option value="${mtype.tid}" <c:if test="${songer.tid == mtype.tid}">selected="selected"</c:if>>${mtype.tname}</option>
                                                    </c:forEach>
                                                </select>
                                        ...
                                        <div class="controls form-group">
                                            <div data-toggle="buttons" class="btn-group col-sm-2" >
                                                <select id="isHot" name="isHot" class="form-control ">
                                                    <option value="1"<c:if test="${songer.isHot == 1}">selected="selected"</c:if>>是</option>
                                                    <option value="0"<c:if test="${songer.isHot == 0}">selected="selected"</c:if>>否</option>
                                                </select>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <textarea class="form-control" name="intro" rows="3" id="intro">${songer.intro}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls form-group">
                                            <div class="col-sm-4 col-md-2">
                                                <div class="image-row">
                                                    <div class="image-set">
                                                        <a class="example-image-link" href="${filePath}${songer.pic}" data-lightbox="example-set" title="Click on the right side of the image to move forward.">
                                                            <img id="songerImg" class="example-image" src="${filePath}${songer.pic}" alt="Plants: image 1 0f 4 thumb" width="150" height="150" />
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="form-actions text-right">
                                    <button id="subSongerUpdate" class="btn btn-primary" type="submit">修改信息</button>
                                </div>
